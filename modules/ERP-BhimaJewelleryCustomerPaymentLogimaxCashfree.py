...
st.set_page_config(
    page_title="Bhima Jewellery - Customer Payment Details",
    layout="wide",
...
# =====================================================
# FILE LOADER FUNCTION - IMPROVED WITH SEPARATE HANDLING
# =====================================================
...
# Determine which report types to load
if report_type == "All":
...
# =====================================================
# DISPLAY EXCEL COLUMN STRUCTURE
# =====================================================
...
# Get min and max dates from both dataframes
all_dates = []
...
# Additional search text for general search
...
# =====================================================
# DASHBOARD OVERVIEW - PROFESSIONAL METRICS
# =====================================================
...
# Create CSV for each report type
csv_data_dict = {}
if not filtered_cashfree.empty:
...
# Combine customer names from both datasets
customer_data = []
if not filtered_logimax.empty:
    name_col = None
    phone_col = None
