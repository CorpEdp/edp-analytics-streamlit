...
# ============================================================
st.set_page_config(
    page_title="E-Gold Scheme Customer Campaign Analysis",
    page_icon="🎯",
    layout="wide"
)
...
# Parse dates - IMPORTANT: Convert to datetime early
df['Paid Date'] = pd.to_datetime(df['Paid Date'], errors='coerce')
...
# Round rates in customer analysis
...
# ============================================================
# SECTION 3: CUSTOMER SEGMENT LIST
# ============================================================
st.markdown("---")
st.subheader("👤 Customer Segments - Campaign Target List")

# Display customers by segment
...
# ============================================================
# SECTION 4: RATE MOVEMENT TIMELINE
# ============================================================
st.markdown("---")
st.subheader("📈 Rate Movement Timeline")

# Show rate movement with key events
